...
AddSubClass("monk", "Way of the Dark Star", {
	...
	features : {
		"subclassfeature1" : {
			...
			calcChanges : {
				atkAdd : ["if (classes.known.monk && classes.known.monk.level > 1 && ((/unarmed/i).test(fields.Description) || (/unarmed/i).test(WeaponName))) {fields.Description += (fields.Description ? '; ' : '') + 'Range: 60ft, Type: Force'}; "]
			},
		},
		"subclassfeature1.1" : {
			name : "Devour Energy",
